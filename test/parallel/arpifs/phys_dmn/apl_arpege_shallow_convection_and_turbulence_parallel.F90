...
!$OMP PARALLEL DO PRIVATE( JBLK, JLEV, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL:ACTKE')) THEN
    ...
    & )
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL:ACTKE:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( KNLAB_CVPP, PCDROV, PCHROV, PCOEFN, PECTCLS, PFLU_CD, PFLU_CH, PKCLS, PKQLROV, PKQROV,  &
!$ACC & PKTROV, PKUROV, PKUROV2, PMSC_LSCPE, PNBVNO, PNEBS, PNEBS0, PPFL_FPLCH, PPFL_FTKE, PPFL_FTKEI, PPRODTH,  &
!$ACC & PPRODTH_CVPP, PQI, PQIC, PQL, PQLC, PQLIS, PQLIS0, PQV, PTKE1, PUSLE, PXTROV, PXUROV, YDCPG_OPTS, YDMODEL, YSTACK,  &
