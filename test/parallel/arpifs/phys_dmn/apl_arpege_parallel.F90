...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:CPPHINP')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:CPPHINP:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:CPPHINP:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZRDG_CVGT, ZRDG_MU0N, ZRDG_SOLO, ZRDG_MU0LU,  &
!$ACC & ZRDG_CVGQ, ZRDG_MU0M, Z_YDVARS_CVGQ_DM, Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDVARS_Q_DL, Z_YDVARS_U_T0, Z_YDVARS_CVGQ_T0,  &
!$ACC & Z_YDVARS_V_T0, Z_YDVARS_T_DM, Z_YDVARS_Q_DM, Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_CVGQ_DL,  &
!$ACC & Z_YDVARS_T_DL, Z_YDCPG_DYN0_CTY_EVEL, Z_YDVARS_Q_T0 ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:APLPAR_INIT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:APLPAR_INIT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZMSC_TW, ZFLU_QSAT, ZFLU_CH, ZPFL_FEFB3, ZFLU_CDN,  &
!$ACC & ZPFL_FEFB2, ZFLU_QSATS, ZFLU_CHN, IMOC_CLPH, ZDSA_C2, ZDSA_LHS, ZMSC_FRMQ, ZDSA_CPS, ZMSC_LSCPE, ZPFL_FEFB1,  &
!$ACC & ZFLU_VEG, ZMSC_QW, ZPFL_FTKEI, ZDSA_C1, ZFLU_NEIJ, ZFLU_FEVI, ZFLU_EMIS, ZFCHQ, ZDSA_RS, ZMSC_LH,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZMSC_TW, ZFLU_QSAT, ZGEOSLC, ZMSC_LSCPE, ZQV, ZMSC_QW,  &
!$ACC & ZMSC_LH, Z_YDCPG_MISC_RH, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, LLHMT )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACSOL:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZCN, ZWFC, ZNEIJG, ZWSMX, ZDSA_C2, ZNEIJV, ZWSEQ, ZWWILT,  &
!$ACC & ZCG, ZDSA_C1, ZC3, ZWPMX, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VV_PARG, Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, Z_YDMF_PHYS_SURF_GSD_VV_PSAB, Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMTLS:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMTLS:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_CDN, ZNBVNO, ZDPHIT, ZDSA_LHS, ZPCLS, ZMRIPP, ZGWDCS,  &
!$ACC & ZRTI, ZPRS, ZDSA_CPS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_GZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACHMT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDPHIT, ZFLU_NEIJ, ZFLU_CD, ZDPHIV, ZSTAB, ZHQ, ZQV, ZHU,  &
!$ACC & ZWFC, ZFLU_CDN, ZFLU_QSATS, ZXHROV, ZCDROV, ZPFL_FPLCH, ZNEIJV, ZDQSTS, ZGWDCS, ZFLU_CH, ZXDROV, ZNBVNO, ZRTI,  &
!$ACC & ZNEIJG, ZPCLS, ZFLU_VEG, ZMRIPP, ZPFL_FPLSH, ZCHROV, ZDSA_RS, ZDSA_CPS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_OUT_NUCLS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_VGST,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PHV, Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_OUT_UCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_OUT_GZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_OUT_RHCLS, Z_YDMF_PHYS_OUT_TCLS,  &
!$ACC & Z_YDCPG_MISC_QS, Z_YDMF_PHYS_SURF_GSD_VF_PVEG ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, JLEV )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACCLPH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACCLPH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACCLPH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZCP, ZQV, ZBLH, ZTHETAV, ZTHETAVS, IMOC_CLPH, ZUGST, ZVGST,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_VEIN, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
!$ACC & Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, JLEV )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:DIFTQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:DIFTQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:DIFTQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDIFCVPPU, ZDIFCVPPQ, ZEDMFU, ZEDMFS, ZEDMFV, ZEDMFQ,  &
!$ACC & ZDIFCVPPS, ZDIFCVPPV, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS )  &
...
!$ACC & Z_YDMF_PHYS_OUT_FRSOPT, Z_YDMF_PHYS_OUT_FRTHDS ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACDRAG')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRAG:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRAG:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZNEBS, ZNBVNO, ZQLIS, ZQV, ZDQSTS, ZCHROV, ZGWDCS, ZMSC_QW,  &
!$ACC & ZFLU_NEIJ, ZFLU_EMIS, ZTRAJGWD, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDMF_PHYS_OUT_DRNSHF, Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, Z_YDMF_PHYS_OUT_STRDV,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_FCSQL,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_FPEVPSN,  &
!$ACC & Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZKCLS, ZTKE1, ZPRODTH, ZUSLE, ZPFL_FTKE, ZKUROV2, ZECTCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_OUT_DIFCS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_OUT_STRCV, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_DIFCQ, Z_YDMF_PHYS_OUT_EDR,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_STRCU ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, JLEV )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:QNGCOR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:QNGCOR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:QNGCOR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZSEDIQL, ZFPLSL, ZQL, ZFPLSN, ZFPCOR, ZPFL_FPLCH,  &
!$ACC & ZFLX_LOTT_GWV, ZPFL_FPLSH, ZQV, ZSEDIQI, ZFLX_LOTT_GWU, ZQI, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FCSQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPCN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_DIFTQN, Z_YDMF_PHYS_OUT_FCSQL,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPEVPCL,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFCQL, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FCQNG, Z_YDMF_PHYS_OUT_FPLSG,  &
!$ACC & Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FCCQN,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFCQN, Z_YDMF_PHYS_OUT_FPLSL ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, JLEV )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACDRME')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRME:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRME:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZMSC_FRMQ, ZQV, Z_YDVARS_LRAD_T1,  &
!$ACC & Z_YDCPG_MISC_QICE, Z_YDVARS_A_T1, Z_YDMF_PHYS_OUT_STRMV, Z_YDCPG_MISC_NEB, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDCPG_MISC_QLI, Z_YDVARS_IRAD_T1,  &
!$ACC & Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACEVADCAPE:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACEVADCAPE:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZBLH, ZTKE1, IMOC_CLPH, ZDCAPE, Z_YDMF_PHYS_OUT_VCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_VGST,  &
!$ACC & Z_YDVARS_GEOMETRY_OROG_T0, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_FPLCL,  &
!$ACC & Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACVISIH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACVISIH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACVISIH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZQS, ZQGM, ZQR, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_OUT_VISICLD,  &
!$ACC & Z_YDMF_PHYS_OUT_MXCLWC, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_VISIHYD, Z_YDCPG_MISC_QICE,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF ) PRIVATE(  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, JLEV )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ZDE2MR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ZDE2MR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ZDE2MR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDE2MR, ZBAY_QRCONV, ZBAY_QSCONV, Z_YDMF_PHYS_BASE_STATE_T,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PPWETPOINT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PPWETPOINT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZPCLS, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_OUT_TPWCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_TCLS, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_L ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:BAYRAD')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:BAYRAD:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:BAYRAD:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZBAY_QSCONV, ZBAY_QRCONV, Z_YDVARS_RCONV_T1,  &
