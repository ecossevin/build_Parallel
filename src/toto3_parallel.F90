...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$ACC PARALLEL LOOP GANG PRESENT( Z_YDMF_PHYS_SURF_GSD_VV_PSAB,Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PARG,ZDSA_C2,ZWSEQ, ZC3,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & ZDSA_C1,Z_YDMF_PHYS_SURF_GSD_VF_PLSM,Z_YDMF_PHYS_OUT_CT, ZWPMX,ZWWILT,Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,ZCG,ZWFC,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,  &
!$ACC & ZNEIJV,Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,ZCN, ZNEIJG,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,ZWSMX,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PLAI,Z_YDMF_PHYS_SURF_GSD_VV_PD2,Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W  &
