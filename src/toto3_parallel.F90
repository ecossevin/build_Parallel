...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$ACC PARALLEL LOOP GANG PRESENT( ZCN,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,ZWWILT,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,ZDSA_C1,Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, ZCG,ZNEIJG,ZWSMX,  &
!$ACC & Z_YDMF_PHYS_OUT_CT,Z_YDMF_PHYS_SURF_GSD_VF_PLSM,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL,Z_YDMF_PHYS_SURF_GSD_VV_PARG,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PD2,ZDSA_C2,ZWFC, Z_YDMF_PHYS_SURF_GSD_VF_PVEG,ZNEIJV,ZWSEQ,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB,Z_YDMF_PHYS_SURF_GSD_VV_PLAI,ZWPMX,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,ZC3,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R ) PRIVATE( JBLK )  &
