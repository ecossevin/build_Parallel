...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$ACC PARALLEL LOOP GANG PRESENT( Z_YDMF_PHYS_SURF_GSD_VF_PVEG,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,ZDSA_C1,  &
!$ACC & ZNEIJV,Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,  &
!$ACC & ZC3,Z_YDMF_PHYS_OUT_CT,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB,ZCN,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,Z_YDMF_PHYS_SURF_GSD_VV_PLAI,ZDSA_C2,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,ZWFC, ZCG,ZWSEQ,ZNEIJG, ZWPMX,ZWWILT,ZWSMX,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_SURF_GSD_VV_PARG  &
