...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        ...
        IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
          ...
          DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
            ...
            & YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, Z_YDMF_PHYS_SURF_GSD_VV_PARG(:, JBLK),  &
            ...
            & ZWSEQ(:, JBLK), ZWSMX(:, JBLK), ZWWIL, YDSTACK=YLSTACK)
    ...
    IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$ACC PARALLEL LOOP GANG PRESENT( Z_YDMF_PHYS_SURF_GSD_VV_PD2,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,ZCN,  &
!$ACC & ZWSMX,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,Z_YDMF_PHYS_SURF_GSD_VV_PLAI,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,ZNEIJG,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVEG,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL,  &
!$ACC & ZDSA_C2,Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,ZDSA_C1, ZC3,ZWPMX,Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB,ZWFC,Z_YDMF_PHYS_OUT_CT,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,Z_YDMF_PHYS_SURF_GSD_VV_PARG,Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,ZNEIJV, ZWWILT,Z_YDMF_PHYS_SURF_GSD_VF_PLSM,ZCG, ZWSEQ )  &
