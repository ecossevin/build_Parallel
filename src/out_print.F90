...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZRDG_MU0, ZRDG_MU0LU, ZRDG_CVGQ, ZRDG_MU0M,  &
!$ACC & ZRDG_CVGT, ZRDG_SOLO, ZRDG_MU0N, Z_YDVARS_V_T0, Z_YDVARS_Q_DM, Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDVARS_CVGQ_T0,  &
!$ACC & Z_YDVARS_CVGQ_DM, Z_YDVARS_Q_DL, Z_YDVARS_T_DM, Z_YDVARS_CVGQ_DL, Z_YDVARS_T_DL, Z_YDCPG_DYN0_CTY_EVEL,  &
!$ACC & Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDVARS_Q_T0, Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_U_T0 ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_QSATS, ZRDG_LCVQ, ZQCO2, ZRDG_CVGQ ) PRIVATE( JBLK )  &
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFCHQ, ZFLU_VEG, ZMSC_FRMQ, ZMSC_LH, ZPFL_FTKE, ZFLU_QSATS,  &
!$ACC & ZMSC_LSCPE, ZFLU_CH, ZPFL_FEFB1, ZFLU_NEIJ, ZFLU_FEVI, ZDSA_LHS, ZFLU_EMIS, ZFLU_CDN, ZPFL_FEFB3, ZMSC_TW, ZDSA_C1,  &
!$ACC & ZPFL_FTKEI, ZPFL_FEFB2, ZFLU_CHN, ZDSA_C2, IMOC_CLPH, ZDSA_CPS, ZMSC_QW, ZDSA_RS, Z_YDMF_PHYS_SURF_GSD_VF_PVEG )  &
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZMSC_LH, ZMSC_LSCPE, ZQV, ZFLU_QSAT, ZMSC_TW, ZMSC_QW,  &
!$ACC & ZGEOSLC, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_T,  &
...
PRINT *,"apl_arpege_parallel_dbg ::: 147"
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$OMP PARALLEL DO PRIVATE( JBLK, LLHMT, JLON ) FIRSTPRIVATE( YLCPG_BNDS )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
        CALL YLCPG_BNDS%UPDATE(JBLK)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZCN, ZWFC, ZWSEQ, ZNEIJV, ZWSMX, ZC3, ZWPMX, ZDSA_C1, ZCG,  &
!$ACC & ZDSA_C2, ZNEIJG, ZWWILT, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_SURF_GSD_VV_PD2,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PARG, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_SURF_GSD_VV_PLAI,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PIVEG ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
PRINT *,"apl_arpege_parallel_dbg ::: 199"
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$OMP PARALLEL DO PRIVATE( JBLK, LLCLS, ZRVMD, JLON ) FIRSTPRIVATE( YLCPG_BNDS )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
        CALL YLCPG_BNDS%UPDATE(JBLK)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZGWDCS, ZDPHI, ZDSA_LHS, ZPCLS, ZFLU_CDN, ZNBVNO, ZPRS,  &
!$ACC & ZMRIPP, ZDSA_CPS, ZDPHIT, ZRTI, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
PRINT *,"apl_arpege_parallel_dbg ::: 225"
      CALL YLCPG_BNDS%INIT(YDCPG_OPTS)
!$OMP PARALLEL DO PRIVATE( JBLK, LLCLS, LLHMT ) FIRSTPRIVATE( YLCPG_BNDS )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
        CALL YLCPG_BNDS%UPDATE(JBLK)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, LLCLS, LLHMT )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
          YLCPG_BNDS%KFDIA = JLON
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZGWDCS, ZFLU_CH, ZPCLS, ZQV, ZXHROV, ZPFL_FPLSH, ZWFC,  &
!$ACC & ZNEIJV, ZFLU_CDN, ZDQSTS, ZRTI, ZCDROV, ZCHROV, ZNBVNO, ZNEIJG, ZMRIPP, ZDPHIT, ZDPHIV, ZDSA_RS, ZFLU_VEG,  &
!$ACC & ZFLU_QSATS, ZFLU_NEIJ, ZHU, ZPFL_FPLCH, ZXDROV, ZHQ, ZDSA_CPS, ZSTAB, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_TCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_GZ0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, Z_YDMF_PHYS_OUT_UCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_BASE_STATE_V, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_OUT_NUCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_VCLS,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_RHCLS, Z_YDMF_PHYS_SURF_GSD_VV_PHV, Z_YDMF_PHYS_OUT_NVCLS )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, LLCLS, LLHMT )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
          YLCPG_BNDS%KFDIA = JLON
          YLSTACK%L8 = stack_l8(YSTACK, JBLK - YDCPG_OPTS%JBLKMIN + 1, YDCPG_OPTS%KGPBLKS)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZUGST, ZTHETAVS, ZQV, ZVGST, ZBLH, IMOC_CLPH, ZCP,  &
!$ACC & Z_YDMF_PHYS_OUT_VEIN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_CLPH, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.0"
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.3"
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.6"
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.7"
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.8"
...
PRINT *,"apl_arpege_parallel_dbg ::: 273.9"
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDIFCVPPQ, ZEDMFQ, ZEDMFS, ZEDMFU, ZDIFCVPPV, ZDIFCVPPU,  &
!$ACC & ZEDMFV, ZDIFCVPPS, Z_YDMF_PHYS_OUT_STRTV, Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_STRTU )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZRDG_MU0, ZFLU_EMIS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_OUT_FRTHDS, Z_YDMF_PHYS_OUT_FRSOPT ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZGWDCS, ZNEBS, ZFLU_NEIJ, ZCHROV, ZQV, ZFLU_EMIS, ZNBVNO,  &
!$ACC & ZQLIS, ZDQSTS, ZTRAJGWD, ZMSC_QW, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_OUT_FPEVPSN,  &
!$ACC & Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_OUT_FCSQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, Z_YDMF_PHYS_OUT_DRNSHF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_V )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZPFL_FTKE, ZTKE1, ZPRODTH, ZKCLS, ZUSLE, ZKUROV2, ZECTCLS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_EDR,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_DIFCQ, Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_STRCV,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_Q,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZSEDIQI, ZQL, ZPFL_FPLCH, ZFPLSL, ZQV, ZFPCOR, ZPFL_FPLSH,  &
!$ACC & ZQI, ZSEDIQL, ZFPLSN, ZFLX_LOTT_GWV, ZFLX_LOTT_GWU, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_DIFCQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_DIFCQL, Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FPEVPSN,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_FPEVPCN, Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_OUT_DIFTQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FPLSG, Z_YDMF_PHYS_OUT_FCQNG, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_FCSQL,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_FPLSL,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZMSC_FRMQ, ZQV,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDVARS_IRAD_T1, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDCPG_MISC_NEB, Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_BASE_STATE_T, Z_YDVARS_A_T1, Z_YDVARS_LRAD_T1,  &
!$ACC & Z_YDMF_PHYS_OUT_STRMV, Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDCPG_MISC_QICE ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK, JLEV )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZTKE1, ZBLH, IMOC_CLPH, ZDCAPE, Z_YDVARS_GEOMETRY_OROG_T0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_VGST,  &
!$ACC & Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_FPLSN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_OUT_UCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZQR, ZQGM, ZQS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_OUT_MXCLWC, Z_YDMF_PHYS_OUT_VISIHYD, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDCPG_MISC_QICE, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_VISICLD ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZBAY_QSCONV, ZBAY_QRCONV, ZDE2MR,  &
...
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZPCLS, Z_YDMF_PHYS_OUT_TPWCLS, Z_YDMF_PHYS_BASE_STATE_Q,  &
!$ACC & Z_YDMF_PHYS_OUT_TCLS, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_BASE_STATE_L ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$ACC & Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
