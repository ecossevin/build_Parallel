...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&PRESENT(ZRDG_CVGQ,ZRDG_LCVQ,ZFLU_QSATS) &
...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&PRESENT(Z_YDMF_PHYS_OUT_STRTV,ZDIFCVPPS,Z_YDMF_PHYS_OUT_DIFTS,Z_YDMF_PHYS_OUT_STRTU,ZDIFCVPPU,Z_YDMF_PHYS_OUT_DIFTQ,ZDIFCVPPV,ZDIFCVPPQ) &
...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&PRESENT(Z_YDMF_PHYS_OUT_FRTH,Z_YDMF_PHYS_OUT_FRSOPT,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,ZRDG_MU0,ZFLU_EMIS,Z_YDMF_PHYS_OUT_FRTHDS) &
