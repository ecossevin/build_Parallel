...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&PRESENT(Z_YDMF_PHYS_OUT_DIFTQ,Z_YDMF_PHYS_OUT_DIFTS,Z_YDMF_PHYS_OUT_STRTU,ZDIFCVPPV,Z_YDMF_PHYS_OUT_STRTV,ZDIFCVPPU,ZDIFCVPPQ,ZDIFCVPPS) &
...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&PRESENT(Z_YDMF_PHYS_OUT_FRTH,Z_YDMF_PHYS_OUT_FRSOPT,Z_YDMF_PHYS_OUT_FRTHDS,ZRDG_MU0,Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,ZFLU_EMIS) &
