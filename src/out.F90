...
#include "apl_arpege_dprecips.intfb.h"
  ...
  <PragmaRegion::>
    ...
    CALL CPPHINP(YDGEOMETRY, YDMODEL, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDVARS%GEOMETRY%GEMU%Z_YDVARS_GEOMETRY_GEMU_T0,  &
    & YDVARS%GEOMETRY%GELAM%Z_YDVARS_GEOMETRY_GELAM_T0, YDVARS%U%Z_YDVARS_U_T0, YDVARS%V%Z_YDVARS_V_T0, YDVARS%Q%Z_YDVARS_Q_T0,  &
    & YDVARS%Q%Z_YDVARS_Q_DL, YDVARS%Q%Z_YDVARS_Q_DM, YDVARS%CVGQ%Z_YDVARS_CVGQ_DL, YDVARS%CVGQ%Z_YDVARS_CVGQ_DM,  &
    & YDCPG_PHY0%XYB%Z_YDCPG_PHY0_XYB_RDELP, YDCPG_DYN0%CTY%Z_YDCPG_DYN0_CTY_EVEL, YDVARS%CVGQ%Z_YDVARS_CVGQ_T0, YL_ZRDG_MU0,  &
    & YL_ZRDG_MU0LU, YL_ZRDG_MU0M, YL_ZRDG_MU0N, YL_ZRDG_CVGQ)
  ...
  IF (YDCPG_OPTS%LCONFX) THEN
    ...
    & YL_ZSAV_UNEBH, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VH%PPBLH,  &
    & YDMF_PHYS_SURF%GSD_VH%PQSH, YDMF_PHYS_SURF%GSD_VH%PSPSH, YDMF_PHYS_SURF%GSD_VK%PUDGRO,  &
    & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDVARS%DAL%T0,  &
    & YDVARS%DOM%T0, YDVARS%UAL%T0, YDVARS%UEN%T0, YDVARS%UNEBH%T0, YDVARS%UOM%T0, YDMODEL)
  ...
  <PragmaRegion::>
    ...
    & YDMODEL%YRML_PHY_G%YRDPHY%NTSSG, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  &
    & YL_ZMSC_FRMQ, YL_ZDSA_CPS, YL_ZDSA_LHS, YL_ZDSA_RS, YL_ZMSC_LH, YL_ZMSC_LSCPE, YL_ZFLU_QSAT, YL_ZMSC_QW, YL_ZMSC_TW,  &
    & YL_ZFLU_CD, YL_ZFLU_CDN, YL_ZFLU_CH, YL_ZDSA_C1, YL_ZDSA_C2, YL_ZFLU_EMIS, YL_ZFLU_FEVI, YL_ZPFL_FTKE, YL_ZPFL_FTKEI,  &
    & YL_ZPFL_FEFB1, YL_ZPFL_FEFB2, YL_ZPFL_FEFB3, YL_ZFLU_NEIJ, YL_ZFLU_VEG, YL_ZFLU_QSATS, YL_IMOC_CLPH)
    
  
  <PragmaRegion::>
    
    DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
      YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM(JLON) =  &
      & REAL(NINT(YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM(JLON)), kind=JPRB)
    END DO
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%LGCHECKMV) THEN
    <PragmaRegion::>
      ...
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, YDVARS%GEOMETRY%GELAM%Z_YDVARS_GEOMETRY_GELAM_T0,  &
      & YDVARS%GEOMETRY%GEMU%Z_YDVARS_GEOMETRY_GEMU_T0, YL_ZRDG_MU0, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
      & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_Q,  &
      & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T)
  END IF
  ...
  <PragmaRegion::>
    ...
    & YDMODEL%YRML_PHY_MF%YRTOPH%NTQSAT, YDCPG_OPTS%KFLEVG,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, YL_ZQV,  &
    & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T, YL_ZGEOSLC, YL_ZMSC_LH, YL_ZMSC_LSCPE, YL_ZFLU_QSAT, YL_ZMSC_QW,  &
    & YDCPG_MISC%Z_YDCPG_MISC_RH, YL_ZMSC_TW)
  ...
  IF (.not.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    <PragmaRegion::>
      ...
      IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
        ...
        & YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PARG,  &
        & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PD2, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
        & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,  &
        & YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,  &
        & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PLAI,  &
        & YDMF_PHYS_BASE_STATE%YGSP_SG%Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A(:, 1),  &
        & YDMF_PHYS_BASE_STATE%YGSP_SG%Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R(:, 1),  &
        & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PSAB,  &
        & YDMF_PHYS_BASE_STATE%YGSP_SG%Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F(:, 1),  &
        & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  &
        & YDMF_PHYS_BASE_STATE%YGSP_SB%Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q(:, 1),  &
        & YDMF_PHYS_BASE_STATE%YGSP_SB%Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL(:, 1),  &
        & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
        & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, LLHMT, YL_ZDSA_C1, YL_ZDSA_C2, YL_ZC3, YL_ZCG, YL_ZCN,  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CT, YL_ZNEIJG, YL_ZNEIJV, YL_ZWFC, YL_ZWPMX, YL_ZWSEQ, YL_ZWSMX, YL_ZWWILT)
      ELSE
        
        !DEC$ IVDEP
        DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
          YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CT(JLON) = YDMODEL%YRML_PHY_MF%YRPHY1%HSOL / (1.0_JPRB +  &
          & YDMODEL%YRML_PHY_MF%YRPHY1%HSOLIWR*(YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W(JLON) +  &
          & YDMF_PHYS_BASE_STATE%YGSP_SB%Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q(JLON, 1)) / (YDMODEL%YRML_PHY_MF%YRPHY1%WSMX +  &
          & YDMODEL%YRML_PHY_MF%YRPHY1%WPMX) &
          & *EXP(-0.5_JPRB*(YDMODEL%YRML_PHY_MF%YRPHY1%HSOLIT0*(YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON &
          & ) - YDMODEL%YRCST%RTT))**2))
        END DO
      END IF
  ...
  IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    <PragmaRegion::>
      ...
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
      & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V,  &
      & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDCPG_MISC%Z_YDCPG_MISC_QS, YL_ZDPHIT,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_GZ0, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_GZ0H, LLCLS, YL_ZNBVNO, YL_ZMRIPP, YL_ZDSA_CPS,  &
      & YL_ZGWDCS, YL_ZDSA_LHS, YL_ZPCLS, YL_ZFLU_CD, YL_ZFLU_CDN)
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YL_ZDPHI(JLON) = YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF(JLON, YDCPG_OPTS%KFLEVG) -  &
        & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI(JLON, YDCPG_OPTS%KFLEVG)
        YL_ZPRS(JLON) = YDMODEL%YRCST%RD + ZRVMD*YDCPG_MISC%Z_YDCPG_MISC_QS(JLON)
        YL_ZRTI(JLON) = 2.0_JPRB / (YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R(JLON,  &
        & YDCPG_OPTS%KFLEVG)*YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T(JLON, YDCPG_OPTS%KFLEVG) +  &
        & YDMODEL%YRCST%RKAPPA*YL_ZDPHI(JLON) + YL_ZPRS(JLON)*YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON) &
        & )
      END DO
  ...
  ELSE
    ...
    <PragmaRegion::>
      ...
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, YL_ZQV,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
      & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V, YL_ZPFL_FPLSH,  &
      & YL_ZPFL_FPLCH, YL_ZDPHIT, YL_ZDPHIV, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
      & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,  &
      & YDMF_PHYS_SURF%GSD_VV%Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YL_ZNEIJG,  &
      & YL_ZNEIJV, YDMF_PHYS_BASE_STATE%YGSP_SG%Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F(:, 1),  &
      & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  &
      & YL_ZWFC, YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
      & YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, LLCLS, LLHMT, YL_ZNBVNO, YL_ZMRIPP, YL_ZFLU_CD,  &
      & YL_ZFLU_CDN, YL_ZCDROV, YL_ZFLU_CH, YL_ZCHROV, YL_ZDSA_CPS, YL_ZDQSTS, YL_ZGWDCS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_GZ0,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_GZ0H, YL_ZHQ, YL_ZHU, YL_ZFLU_NEIJ, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_QCLS,  &
      & YDCPG_MISC%Z_YDCPG_MISC_QS, YL_ZFLU_QSATS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_RHCLS, YL_ZDSA_RS, YL_ZRTI, YL_ZSTAB,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_TCLS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VCLS,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_NUCLS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_NVCLS, YL_ZPCLS, YL_ZFLU_VEG, YL_ZXDROV, YL_ZXHROV,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VGST)
  ...
  <PragmaRegion::>
    ...
    DO JLEV=1,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YL_ZCP(JLON, JLEV) = YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP(JLON, JLEV)
      END DO
    END DO
    
    DO JLEV=YDCPG_OPTS%KTDIA,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YL_ZTHETAV(JLON, JLEV) = YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T(JLON, JLEV)*(1.0_JPRB +  &
        & YDMODEL%YRCST%RETV*YL_ZQV(JLON, JLEV))*(YDMODEL%YRCST%RATM /  &
        & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF(JLON, JLEV))**YDMODEL%YRCST%RKAPPA
      END DO
    END DO
    
    DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
      YL_ZTHETAVS(JLON) = YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON)*(1.0_JPRB +  &
      & YDMODEL%YRCST%RETV*YDCPG_MISC%Z_YDCPG_MISC_QS(JLON))*(YDMODEL%YRCST%RATM /  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD(JLON, YDCPG_OPTS%KFLEVG))**YDMODEL%YRCST%RKAPPA
    END DO
    
    CALL ACCLPH(YDMODEL%YRCST, YDMODEL%YRML_PHY_MF%YRPHY0, YDMODEL%YRML_PHY_MF%YRPHY2, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA,  &
    & YDCPG_OPTS%KLON, YDCPG_OPTS%KTDIA, YDCPG_OPTS%KFLEVG, YL_ZTHETAV,  &
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U,  &
    & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V, YL_ZTHETAVS, YL_IMOC_CLPH, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CLPH,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VEIN, YL_ZUGST, YL_ZVGST)
    
    
    DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
      YL_ZBLH(JLON) = YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CLPH(JLON)
    END DO
  ...
  <PragmaRegion::>
    ...
    DO JLEV=YDCPG_OPTS%KTDIA,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQ(JLON, JLEV) =  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQ(JLON, JLEV) + YL_ZDIFCVPPQ(JLON, JLEV)
  ...
  <PragmaRegion::>
    ...
    DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
      ...
      & YDMODEL%YRCST%RSIGMA*YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON)**4
  ...
  <PragmaRegion::>
    ...
    IF (YDMODEL%YRML_AOC%YRMCC%LMCC03) THEN
      ...
      & YDCPG_OPTS%KLON, YDCPG_OPTS%KTDIA, YDCPG_OPTS%KFLEVG, YL_ZFLU_EMIS, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
      & YL_ZFLU_NEIJ, YL_ZQV, YDCPG_MISC%Z_YDCPG_MISC_QS, YDMF_PHYS_BASE_STATE%YGSP_RR%Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
      & YL_ZCHROV, YL_ZDQSTS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DRNSHF)
    END IF
    
    CALL ACDRAG(YDMODEL%YRCST, YDMODEL%YRML_PHY_MF, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON,  &
    & YDMODEL%YRML_PHY_MF%YRTOPH%NTDRAG, YDCPG_OPTS%KFLEVG,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, YL_ZNBVNO,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP,  &
    & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V,  &
    & YDVARS%GEOMETRY%RCORI%Z_YDVARS_GEOMETRY_RCORI_T0, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, YL_ZGWDCS,  &
    & YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, YDMF_PHYS_SURF%GSD_VF%Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_STRDU, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_STRDV, YL_ZTRAJGWD)
    ...
    IF (YDMODEL%YRML_PHY_MF%YRPHY%LSTRAS) THEN
      ...
      & YDMODEL%YRML_PHY_MF%YRTOPH%NTPLUI, YDCPG_OPTS%KFLEVG,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, YL_ZNEBS, YL_ZQV, YL_ZQLIS, YL_ZMSC_QW,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCSQL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCSQN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSL,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPSL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPSN,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPSL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPSN)
    END IF
  ...
  <PragmaRegion::>
    ...
    IF (YDMODEL%YRML_PHY_MF%YRPHY%LRRGUST) THEN
      DO JLEV=YDCPG_OPTS%KTDIA - 1,YDCPG_OPTS%KFLEVG
        DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
          YL_ZPFL_FPLSH(JLON, JLEV) = YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSL(JLON, JLEV) + YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSN(JLON, &
          &  JLEV) + YDMF_PHYS%OUT%FPLSG(JLON, JLEV)
        END DO
      END DO
    END IF
    ...
    DO JLEV=YDCPG_OPTS%KTDIA,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQL(JLON, JLEV) =  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQL(JLON, JLEV) + YL_ZSEDIQL(JLON, JLEV)
        YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQN(JLON, JLEV) =  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQN(JLON, JLEV) + YL_ZSEDIQI(JLON, JLEV)
        YL_ZFPLSL(JLON, JLEV) =  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQL(JLON, JLEV) + YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSL(JLON, JLEV)
        YL_ZFPLSN(JLON, JLEV) =  &
        & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQN(JLON, JLEV) + YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSN(JLON, JLEV)
      END DO
    END DO
    ...
    & YDMODEL%YRML_PHY_MF%YRTOPH%NTPLUI, YDCPG_OPTS%KFLEVG, YL_ZQV, YL_ZQL, YL_ZQI,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFCQ,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFCQN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFCQL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQ,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_DIFTQL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPSL,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPSN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPCL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPEVPCN,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPSL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPSN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPCL,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPFPCN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCCQL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCCQN,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCSQL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCSQN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FCQNG)
  ...
  <PragmaRegion::>
    ...
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
    & YL_ZQV, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FRMH, YL_ZMSC_FRMQ, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_STRMU, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_STRMV)
    ...
    IF (YDMODEL%YRML_GCONF%YGFL%YIRAD%LGP) THEN
      DO JLEV=1,YDCPG_OPTS%KFLEVG
        DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
          YDVARS%IRAD%T1(JLON, JLEV) = YDCPG_MISC%Z_YDCPG_MISC_QICE(JLON, JLEV)
        END DO
      END DO
    END IF
    ...
    IF (YDMODEL%YRML_GCONF%YGFL%YLRAD%LGP) THEN
      DO JLEV=1,YDCPG_OPTS%KFLEVG
        DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
          YDVARS%LRAD%T1(JLON, JLEV) = YDCPG_MISC%Z_YDCPG_MISC_QLI(JLON, JLEV)
        END DO
      END DO
    END IF
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
    ...
    <PragmaRegion::>
      ...
      & YDCPG_OPTS%KFLEVG, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSN,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCN,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, YL_ZDCAPE)
      ...
      & YDCPG_OPTS%KFLEVG, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VCLS,  &
      & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_V,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CAPE, YL_ZDCAPE, YL_ZTKE1,  &
      & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, YDVARS%GEOMETRY%OROG%Z_YDVARS_GEOMETRY_OROG_T0,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VGST, YL_ZBLH, YL_IMOC_CLPH)
      
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_CLPH(JLON) =  &
        & MIN(YDMODEL%YRML_PHY_MF%YRPHY0%XMAXLM, MAX(YDMODEL%YRML_PHY_MF%YRPHY0%XMINLM, YL_ZBLH(JLON)))
      END DO
  ...
  <PragmaRegion::>
    ...
    & YDCPG_OPTS%KTDIA, YDCPG_OPTS%KFLEVG, YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
    & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T,  &
    & YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, YDCPG_MISC%Z_YDCPG_MISC_QLI,  &
    & YDCPG_MISC%Z_YDCPG_MISC_QICE, YL_ZQR, YL_ZQS, YL_ZQGM, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VISICLD,  &
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_VISIHYD, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_MXCLWC)
  ...
  <PragmaRegion::>
    ...
    DO JLEV=1,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YL_ZBAY_QRCONV(JLON, JLEV) = 0.001_JPRB*((ABS(YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCL(JLON, JLEV)) &
        & *YDMODEL%YRML_PHY_MF%YRPHY0%RCOEFRAIN(1))**YDMODEL%YRML_PHY_MF%YRPHY0%RCOEFRAIN(2))
        YL_ZBAY_QSCONV(JLON, JLEV) = 0.001_JPRB*((ABS(YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCN(JLON, JLEV)) &
  ...
  <PragmaRegion::>
    ...
    DO JLEV=1,YDCPG_OPTS%KFLEVG
      DO JLON=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
        YL_ZDE2MR(JLON, JLEV) = YDMODEL%YRCST%RD*YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_T(JLON, JLEV) /  &
        & YDMF_PHYS_BASE_STATE%YCPG_PHY%Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF(JLON, JLEV)
  ...
  <PragmaRegion::>
    ...
    & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_TCLS, YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_Q(:, YDCPG_OPTS%KFLEVG),  &
    & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_L(:, YDCPG_OPTS%KFLEVG),  &
    & YDMF_PHYS_BASE_STATE%Z_YDMF_PHYS_BASE_STATE_I(:, YDCPG_OPTS%KFLEVG), YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_TPWCLS)
  ...
  IF (YDCPG_OPTS%LCORWAT) THEN
    ...
    <PragmaRegion::>
      ...
      CALL MF_PHYS_CORWAT(YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FEVL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FEVN,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSL,  &
      & YDMF_PHYS%OUT%Z_YDMF_PHYS_OUT_FPLSN, YDMF_PHYS_SURF%GSD_VH%Z_YDMF_PHYS_SURF_GSD_VH_PEVA,  &
      & YDMF_PHYS_SURF%GSD_VH%Z_YDMF_PHYS_SURF_GSD_VH_PPCL, YDMF_PHYS_SURF%GSD_VH%Z_YDMF_PHYS_SURF_GSD_VH_PPCN,  &
      & YDMF_PHYS_SURF%GSD_VH%Z_YDMF_PHYS_SURF_GSD_VH_PPSL, YDMF_PHYS_SURF%GSD_VH%Z_YDMF_PHYS_SURF_GSD_VH_PPSN)
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%NDPSFI == 1) THEN
    ...
    <PragmaRegion::>
      ...
      & YDCPG_BNDS%KFDIA, YDCPG_PHY0%Z_YDCPG_PHY0_PREHYD, YDMF_PHYS_SURF%GSP_RR%Z_YDMF_PHYS_SURF_GSP_RR_PT_T0,  &
      & YDCPG_MISC%Z_YDCPG_MISC_QS, YL_ZFLU_QSATS, YDCPG_MISC%Z_YDCPG_MISC_QSOL)
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%LCVPGY) THEN
    ...
    <PragmaRegion::>
      ...
      CALL MF_PHYS_CVV(YDCPG_BNDS, YDCPG_OPTS, YDVARS%CVV%Z_YDVARS_CVV_T0, YDVARS%CVV%Z_YDVARS_CVV_T1)
  ...
  <PragmaRegion::>
    ...
    CALL MF_PHYS_BAYRAD(YDCPG_BNDS, YDCPG_OPTS, YL_ZBAY_QRCONV, YL_ZBAY_QSCONV, YDVARS%RCONV%Z_YDVARS_RCONV_T1,  &
    & YDVARS%SCONV%Z_YDVARS_SCONV_T1, YDMODEL)
  ...
  <PragmaRegion::>
    ...
    CALL MF_PHYS_PRECIPS(YDCPG_BNDS, YDCPG_OPTS, YL_ZPRC_DPRECIPS, YL_ZPRC_DPRECIPS2,  &
    & YDMF_PHYS_SURF%GSD_XP%Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP2%Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMODEL)
