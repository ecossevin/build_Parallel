...
#include "apl_arpege_dprecips.intfb.h"
  ...
  <PragmaRegion::>
    ...
    & ZFLU_EMIS, ZFLU_FEVI, ZPFL_FTKE, ZPFL_FTKEI, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, ZFLU_NEIJ, ZFLU_VEG, ZFLU_QSATS, IMOC_CLPH &
    & )
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%LGCHECKMV) THEN
    <PragmaRegion::>
      ...
      & YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF, YDVARS%GEOMETRY%GELAM%T0, YDVARS%GEOMETRY%GEMU%T0, ZRDG_MU0,  &
  ...
  IF (.not.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    <PragmaRegion::>
      ...
      IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
        ...
        & YDMF_PHYS_BASE_STATE%YGSP_RR%W, YDMF_PHYS_BASE_STATE%YGSP_RR%IC, LLHMT, ZDSA_C1, ZDSA_C2, ZC3, ZCG, ZCN,  &
        & YDMF_PHYS%OUT%CT, ZNEIJG, ZNEIJV, ZWFC, ZWPMX, ZWSEQ, ZWSMX, ZWWILT)
      ELSE
  ...
  ELSE
    ...
    <PragmaRegion::>
      ...
      & YDMF_PHYS_SURF%GSD_VV%PZ0H, YDMF_PHYS_SURF%GSD_VF%PZ0RLF, YDMF_PHYS_SURF%GSD_VV%PHV, YDMF_PHYS_SURF%GSD_VF%PLSM, ZNEIJG,  &
      & ZNEIJV, YDMF_PHYS_BASE_STATE%YGSP_SG%F(:, 1), YDMF_PHYS_BASE_STATE%YGSP_RR%T, YDMF_PHYS_SURF%GSD_VF%PVEG, ZWFC,  &
      & YDMF_PHYS_BASE_STATE%YGSP_RR%W, YDMF_PHYS_BASE_STATE%YGSP_RR%IC, LLCLS, LLHMT, ZNBVNO, ZMRIPP, ZFLU_CD, ZFLU_CDN,  &
      & ZCDROV, ZFLU_CH, ZCHROV, ZDSA_CPS, ZDQSTS, ZGWDCS, YDMF_PHYS%OUT%GZ0, YDMF_PHYS%OUT%GZ0H, ZHQ, ZHU, ZFLU_NEIJ,  &
      & YDMF_PHYS%OUT%QCLS, YDCPG_MISC%QS, ZFLU_QSATS, YDMF_PHYS%OUT%RHCLS, ZDSA_RS, ZRTI, ZSTAB, YDMF_PHYS%OUT%TCLS,  &
      & YDMF_PHYS%OUT%UCLS, YDMF_PHYS%OUT%VCLS, YDMF_PHYS%OUT%NUCLS, YDMF_PHYS%OUT%NVCLS, ZPCLS, ZFLU_VEG, ZXDROV, ZXHROV,  &
      & YDMF_PHYS%OUT%UGST, YDMF_PHYS%OUT%VGST)
  ...
  <PragmaRegion::>
    ...
    IF (YDMODEL%YRML_DIAG%YRLDDH%LFLEXDIA) THEN
      CALL APLPAR_FLEXDIA(YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, YDMODEL, YDDDH, YDMF_PHYS_BASE_STATE)
    END IF
