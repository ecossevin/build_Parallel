...
#include "apl_arpege_dprecips_parallel.intfb.h"
  ...
  CALL FIELD_NEW(YL_ZRDG_CVGQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZRDG_LCVQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZMSC_LH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZMSC_TW, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_IMOC_CLPH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_QW, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_LSCPE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLU_QSAT, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZFLU_FEVI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KTSSG + 1, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZBAY_QSCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZBAY_QRCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDE2MR, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRC_DPRECIPS2, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%NDTPREC2, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 1, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRC_DPRECIPS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%NDTPREC, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_HV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_DDOM, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSAV_DDAL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSAV_ENTCH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_UDOM, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_UNEBH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSAV_UDAL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 1, 1 /),  &
  & PERSISTENT=.true.)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:CPPHINP')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CPPHINP:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CPPHINP:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_MU0, ZRDG_MU0LU, ZRDG_CVGQ, ZRDG_MU0M,  &
!$ACC & ZRDG_MU0N, Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_CVGQ_DM, Z_YDVARS_CVGQ_T0, Z_YDVARS_CVGQ_DL, Z_YDVARS_U_T0,  &
!$ACC & Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDCPG_DYN0_CTY_EVEL, Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDVARS_Q_DL, Z_YDVARS_V_T0,  &
!$ACC & Z_YDVARS_Q_T0, Z_YDVARS_Q_DM, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZRDG_LCVQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZRDG_LCVQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZRDG_LCVQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_QSATS, ZRDG_CVGQ, ZRDG_LCVQ, ) PRIVATE( JBLK )  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:APLPAR_INIT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:APLPAR_INIT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:APLPAR_INIT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_QSATS, ZDSA_LHS, ZDSA_C2, ZFLU_CD, ZMSC_LH,  &
!$ACC & ZDSA_C1, ZFLU_CH, ZFLU_EMIS, ZMSC_TW, IMOC_CLPH, ZMSC_QW, ZMSC_LSCPE, ZDSA_RS, ZPFL_FEFB2, ZPFL_FTKE, ZPFL_FEFB1,  &
!$ACC & ZMSC_FRMQ, ZFLU_QSAT, ZFLU_CDN, ZFLU_NEIJ, ZPFL_FTKEI, ZFLU_VEG, ZPFL_FEFB3, ZDSA_CPS, ZFLU_FEVI,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:CHECKMV')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CHECKMV:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:CHECKMV:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_MU0, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACTQSAT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACTQSAT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACTQSAT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZGEOSLC, ZQV, ZMSC_LH, ZMSC_TW, ZMSC_QW, ZMSC_LSCPE,  &
!$ACC & ZFLU_QSAT, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
...
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
  ...
  IF (.not.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    IF (LPARALLELMETHOD('OPENMP', 'APL_ARPEGE:ACSOL')) THEN
      ...
      Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q => GET_HOST_DATA_RDWR(YDMF_PHYS_BASE_STATE%YGSP_SB%F_Q(JLON, 1))
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACSOL')) THEN
      ...
      Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q => GET_DEVICE_DATA_RDWR(YDMF_PHYS_BASE_STATE%YGSP_SB%F_Q(JLON, 1))
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZWPMX, ZDSA_C2, ZWSMX, ZDSA_C1, ZC3, ZNEIJV, ZWFC,  &
!$ACC & ZCN, ZWWILT, ZWSEQ, ZCG, ZNEIJG, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_SURF_GSD_VV_PLAI, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, Z_YDMF_PHYS_SURF_GSD_VV_PSAB,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_SURF_GSD_VV_PARG, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZDPHIV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZDPHIV:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZDPHIV:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDPHIT, ZDPHIV, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACHMTLS')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMTLS:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMTLS:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDSA_LHS, ZFLU_CD, ZDPHI, ZPRS, ZDPHIT, ZNBVNO,  &
!$ACC & ZMRIPP, ZPCLS, ZRTI, ZGWDCS, ZFLU_CDN, ZDSA_CPS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_OUT_GZ0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACHMT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACHMT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDPHIV, ZDQSTS, ZFLU_CD, ZCHROV, ZXDROV, ZXHROV,  &
!$ACC & ZNEIJV, ZHU, ZGWDCS, ZDSA_CPS, ZSTAB, ZQV, ZPFL_FPLCH, ZFLU_CH, ZNBVNO, ZPFL_FPLSH, ZPCLS, ZFLU_VEG, ZCDROV, ZDPHIT,  &
!$ACC & ZWFC, ZFLU_QSATS, ZDSA_RS, ZMRIPP, ZRTI, ZHQ, ZFLU_CDN, ZFLU_NEIJ, ZNEIJG, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_OUT_GZ0H, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_SURF_GSD_VV_PHV,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_NUCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_TCLS, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_OUT_RHCLS, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_UCLS,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, ) PRIVATE( JBLK  &
!$ACC & ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACCLPH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACCLPH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACCLPH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZTHETAV, ZBLH, ZCP, ZUGST, IMOC_CLPH, ZQV, ZVGST,  &
!$ACC & ZTHETAVS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_OUT_CLPH,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_VEIN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:DIFTQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:DIFTQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:DIFTQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDIFCVPPQ, ZDIFCVPPV, ZDIFCVPPS, ZDIFCVPPU,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV, ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:FRSOPT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:FRSOPT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:FRSOPT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_MU0, ZFLU_EMIS, Z_YDMF_PHYS_OUT_FRTHDS,  &
!$ACC & Z_YDMF_PHYS_OUT_FRSOPT, Z_YDMF_PHYS_OUT_FRTH, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACDRAG')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRAG:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRAG:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDQSTS, ZQV, ZCHROV, ZFLU_EMIS, ZMSC_QW, ZNBVNO,  &
!$ACC & ZNEBS, ZTRAJGWD, ZGWDCS, ZFLU_NEIJ, ZQLIS, Z_YDMF_PHYS_OUT_DRNSHF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_FPFPSN,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_BASE_STATE_V, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_OUT_FPLSN,  &
!$ACC & Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_OUT_FCSQN, Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, )  &
...
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
  ...
  IF (LPARALLELMETHOD('OPENMP', 'APL_ARPEGE:QNGCOR')) THEN
    ...
    ZPFL_FPLCH => GET_HOST_DATA_RDWR(YL_ZPFL_FPLCH)
    Z_YDMF_PHYS_OUT_DIFTQN => GET_HOST_DATA_RDWR(YDMF_PHYS%OUT%F_DIFTQN(JLON, JLEV))
    Z_YDMF_PHYS_OUT_FPEVPSL => GET_HOST_DATA_RDWR(YDMF_PHYS%OUT%F_FPEVPSL)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:QNGCOR')) THEN
    ...
    ZPFL_FPLCH => GET_DEVICE_DATA_RDWR(YL_ZPFL_FPLCH)
    Z_YDMF_PHYS_OUT_DIFTQN => GET_DEVICE_DATA_RDWR(YDMF_PHYS%OUT%F_DIFTQN(JLON, JLEV))
    Z_YDMF_PHYS_OUT_FPEVPSL => GET_DEVICE_DATA_RDWR(YDMF_PHYS%OUT%F_FPEVPSL)
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:QNGCOR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:QNGCOR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFPCOR, ZQV, ZFLX_LOTT_GWV, ZSEDIQI, ZFPLSN,  &
!$ACC & ZPFL_FPLSH, ZQI, ZFPLSL, ZFLX_LOTT_GWU, ZQL, ZSEDIQL, ZPFL_FPLCH, Z_YDMF_PHYS_OUT_DIFTQN, Z_YDMF_PHYS_OUT_FPEVPSL,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_DIFCQ,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_OUT_FPLSG,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_DIFCQN, Z_YDMF_PHYS_OUT_DIFCQL, Z_YDMF_PHYS_OUT_FPFPCN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FCQNG, Z_YDMF_PHYS_OUT_FPLSL,  &
!$ACC & Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_FPEVPCN, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACDRME')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRME:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACDRME:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZQV, ZMSC_FRMQ,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDVARS_IRAD_T1, Z_YDMF_PHYS_BASE_STATE_T, Z_YDVARS_A_T1,  &
!$ACC & Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_U,  &
!$ACC & Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_OUT_STRMV, Z_YDMF_PHYS_BASE_STATE_V, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QICE,  &
!$ACC & Z_YDVARS_LRAD_T1, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACEVADCAPE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACEVADCAPE:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACEVADCAPE:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZDCAPE, ZBLH, IMOC_CLPH, ZTKE1,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_U, Z_YDVARS_GEOMETRY_OROG_T0,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_FPLCL,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_OUT_FPLCN, ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ACVISIH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACVISIH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ACVISIH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZQR, ZQGM, ZQS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDCPG_MISC_QICE, Z_YDMF_PHYS_OUT_VISICLD, Z_YDMF_PHYS_OUT_VISIHYD, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_OUT_MXCLWC,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZBAY_QRCONV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZBAY_QRCONV:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZBAY_QRCONV:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZBAY_QSCONV, ZBAY_QRCONV, Z_YDMF_PHYS_OUT_FPLCN,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:ZDE2MR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZDE2MR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:ZDE2MR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZBAY_QRCONV, ZDE2MR, ZBAY_QSCONV,  &
...
!$ACC & Z_YDMF_PHYS_OUT_TCLS, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_OUT_TPWCLS, ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:0')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:0:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:0:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDMF_PHYS_SURF_GSD_VH_PEVA, Z_YDMF_PHYS_OUT_FPLSL,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VH_PPSL, Z_YDMF_PHYS_OUT_FEVL, Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_SURF_GSD_VH_PPSN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_SURF_GSD_VH_PPCN, Z_YDMF_PHYS_OUT_FEVN, Z_YDMF_PHYS_OUT_FPLCL,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VH_PPCL, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:1')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:1:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:1:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZFLU_QSATS, Z_YDMF_PHYS_SURF_GSP_RR_PT_T0,  &
!$ACC & Z_YDCPG_MISC_QS, Z_YDCPG_PHY0_PREHYD, Z_YDCPG_MISC_QSOL, ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:BAYRAD')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:BAYRAD:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:BAYRAD:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZBAY_QSCONV, ZBAY_QRCONV, Z_YDVARS_SCONV_T1,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE:EDR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:EDR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE:EDR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_SURF_GSD_DI_PXEDR, )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
