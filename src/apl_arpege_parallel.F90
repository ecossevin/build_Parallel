SUBROUTINE APL_ARPEGE_PARALLEL (YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE,&
& YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDMF_PHYS&
&, YDCPG_DYN0, YDMF_PHYS_SURF, YDCPG_SL2, YDVARS, YDMODEL, YDDDH)
...
CALL FIELD_NEW (YL_ZXUROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZXURO, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZXTROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZXTRO, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZXQRO, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZUNEBH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZTRSODIR, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTRSODIF, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTRSOD, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTRAJGWD, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTKE1, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTHETAVS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTHETAV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTENT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTENQVA, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZTENHA, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZSFSWDIR, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSFSWDIF, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSEDIQL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSEDIQI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZSAV_UNEBH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSAV_UDOM, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSAV_UDGRO, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSAV_UDAL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZSAV_ENTCH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSAV_DDOM, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZSAV_DDAL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZRDG_LCVQ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZRDG_CVGQ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQR, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQO3, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQLI_CVPP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQLI_CVP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQLIS0, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQLIS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQLC, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQICE, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQIC, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQGM, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZQC_DET_PCMT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPRS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPRODTH_CVPP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPRC_DPRECIPS2, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%NDTPREC2, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPRC_DPRECIPS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%NDTPREC, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPOID, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FTKEI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FTKE, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FPLSH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FPLCH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FEFB3, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FEFB2, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZPFL_FEFB1, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZNEB_CVPP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNEBS0, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNEBS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNEBDIFF, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNEBCH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNEBC0, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZNBVNO, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMSC_TW, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMSC_QW, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMSC_LSCPE, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMSC_LH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMSC_FRMQ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMRIPP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZMF_UP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZLVT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZKUROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZKTROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZKQROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZKQLROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZGP2DSPP, UBOUNDS=[YDCPG_OPTS%KLON, YDMODEL%YRML_GCONF&
&%YRSPP_CONFIG%SM%NRFTOTAL, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZGEOSLC, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFPLSN, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFPLSL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFPCOR, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFLX_LOTT_GWV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFLX_LOTT_GWU, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZFLU_QSAT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFLU_NEIJ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZFLU_FEVI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KTSSG+1, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZEDMFV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZEDMFU, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZEDMFS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZEDMFQ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZDIFEXT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDMODEL%YRML_GCONF&
&%YGFL%NGFL_EXT, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDIFCVPPV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDIFCVPPU, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDIFCVPPS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDIFCVPPQ, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDECRD, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDE2MR, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZDCAPE, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCTRSO, UBOUNDS=[YDCPG_OPTS%KLON, 1, YDCPG_OPTS&
&%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCRTI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCONDCVPPL, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCONDCVPPI, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCOEFN, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCOEFA, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZCFBV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCFBU, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCFBTH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCFAU, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCFATH, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCEROV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZCEMTR, UBOUNDS=[YDCPG_OPTS%KLON, 1, YDCPG_OPTS&
&%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
...
CALL FIELD_NEW (YL_ZBAY_QSCONV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZBAY_QRCONV, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZALPHA1, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG&
&, YDCPG_OPTS%KGPBLKS], LBOUNDS=[1, 0, 1], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZALBP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZALBD, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KSW, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZAIPCMT, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZAERINDS, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_ZAER, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, 6, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
CALL FIELD_NEW (YL_INLAB_CVPP, UBOUNDS=[YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDCPG_OPTS%KGPBLKS], PERSISTENT=.TRUE.)
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  DO JBLK = 1, YDCPG_OPTS%KGPBLKS
    ...
    &(:, JBLK), ZRDG_MU0N(:, JBLK), ZRDG_CVGQ(:,:, JBLK))  
  ENDDO
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
  ...
  DO JBLK = 1, YDCPG_OPTS%KGPBLKS
    ...
    &(:, JBLK), ZMSC_FRMQ(:,:, JBLK), ZDSA_CPS(:, JBLK), ZDSA_LHS(:, JBLK), ZDSA_RS(:, JBLK), ZMSC_LH&
    &(:,:, JBLK), ZMSC_LSCPE(:,:, JBLK), ZFLU_QSAT(:,:, JBLK), ZMSC_QW(:,:, JBLK), ZMSC_TW(:,:, JBLK&
    &), ZFLU_CD(:, JBLK), ZFLU_CDN(:, JBLK), ZFLU_CH(:, JBLK), ZDSA_C1(:, JBLK), ZDSA_C2(:, JBLK)&
    &, ZFLU_EMIS(:, JBLK), ZFLU_FEVI(:,:, JBLK), ZPFL_FTKE(:,:, JBLK), ZPFL_FTKEI(:,:, JBLK), ZPFL_FEFB1&
    &(:,:, JBLK), ZPFL_FEFB2(:,:, JBLK), ZPFL_FEFB3(:,:, JBLK), ZFLU_NEIJ(:, JBLK), ZFLU_VEG(:, JBLK&
    &), ZFLU_QSATS(:, JBLK), IMOC_CLPH(:, JBLK))  
  ENDDO
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
  ...
  DO JBLK = 1, YDCPG_OPTS%KGPBLKS
      ...
      DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        CALL APLPAR_INIT_OPENACC (YDCPG_OPTS%LAROME, YLCPG_BNDS%KIDIA, YLCPG_BNDS%KFDIA, YDCPG_OPTS%KLON&
      &, YDCPG_OPTS%KFLEVG, YDMODEL%YRML_PHY_G%YRDPHY%NTSSG, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, Z_YDMF_PHYS_SURF_GSD_VF_PVEG&
      &(:, JBLK), ZMSC_FRMQ(:,:, JBLK), ZDSA_CPS(:, JBLK), ZDSA_LHS(:, JBLK), ZDSA_RS(:, JBLK), ZMSC_LH&
      &(:,:, JBLK), ZMSC_LSCPE(:,:, JBLK), ZFLU_QSAT(:,:, JBLK), ZMSC_QW(:,:, JBLK), ZMSC_TW(:,:, JBLK&
      &), ZFLU_CD(:, JBLK), ZFLU_CDN(:, JBLK), ZFLU_CH(:, JBLK), ZDSA_C1(:, JBLK), ZDSA_C2(:, JBLK), ZFLU_EMIS&
      &(:, JBLK), ZFLU_FEVI(:,:, JBLK), ZPFL_FTKE(:,:, JBLK), ZPFL_FTKEI(:,:, JBLK), ZPFL_FEFB1(:,:, JBLK&
      &), ZPFL_FEFB2(:,:, JBLK), ZPFL_FEFB3(:,:, JBLK), ZFLU_NEIJ(:, JBLK), ZFLU_VEG(:, JBLK), ZFLU_QSATS&
      &(:, JBLK), IMOC_CLPH(:, JBLK),YDSTACK=YLSTACK)  
      ENDDO
...
CALL APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS&
&, YDCPG_MISC, YDMF_PHYS, YDMODEL, YDDDH, YL_INLAB_CVPP, YL_ZCDROV, YL_ZCHROV, YL_ZCOEFN, YL_ZCONDCVPPI&
&, YL_ZCONDCVPPL, YL_ZDIFCVPPQ, YL_ZDIFCVPPS, YDMODEL%YRML_PHY_MF%YRPHY0%REPS, YL_ZFLU_CD, YL_ZFLU_CH&
&, YL_ZKQLROV, YL_ZKQROV, YL_ZKTROV, YL_ZKUROV, YL_ZMSC_LSCPE, YL_ZNBVNO, YL_ZNEBS, YL_ZNEBS0, YL_ZNEB_CVPP&
&, YL_ZPFL_FPLCH, YL_ZPFL_FTKE, YL_ZPFL_FTKEI, YL_ZPRODTH_CVPP, YL_ZQI, YL_ZQIC, YL_ZQL, YL_ZQLC, YL_ZQLIS&
&, YL_ZQLIS0, YL_ZQLI_CVPP, YL_ZQV, YL_ZTKE1, YL_ZXTROV, YL_ZXUROV)
CALL APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS&
&, YDMF_PHYS_SURF, YDMODEL, YL_ZALBD, YL_ZALBP, ZEPS0, YL_ZFLU_EMIS, YL_ZFLU_NEIJ, YL_ZRDG_MU0)
...
CALL APL_ARPEGE_CLOUDINESS_PARALLEL (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS, YDCPG_MISC&
&, YDMF_PHYS, YDVARS, YDMODEL, LLREDPR, YL_ZAIPCMT, YL_ZBLH, YL_ZDECRD, YL_ZFLU_QSAT, YL_ZMSC_QW&
&, YL_ZNEBC0, YL_ZNEBCH, YL_ZNEBS, YL_ZNEBS0, YL_ZNEB_CVPP, YL_ZPFL_FPLCH, YL_ZQI, YL_ZQL, YL_ZQLIS&
&, YL_ZQLIS0, YL_ZQLI_CVP, YL_ZQLI_CVPP, YL_ZQV, YL_ZUNEBH, YDGEOMETRY%YRSTA)
CALL APL_ARPEGE_RADIATION_PARALLEL (YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS&
&, YDCPG_MISC, YDCPG_GPAR, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDMODEL, YL_ZAER, YL_ZAERINDS&
&, YL_ZALBD, YL_ZALBP, YL_ZCEMTR, YL_ZCTRSO, YL_ZFLU_EMIS, YL_ZFLU_QSAT, YL_ZQO3, YL_ZQR&
&, YL_ZQS, YL_ZQV, YL_ZRDG_MU0, YL_ZRDG_MU0LU, YL_ZRDG_MU0M, YL_ZSFSWDIF, YL_ZSFSWDIR&
...
CALL APL_ARPEGE_DEEP_CONVECTION_PARALLEL (YDMF_PHYS_BASE_STATE, YDGEOMETRY&
&, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDVARS&
&, YDMODEL, YL_ZFPCOR, YL_ZQV, YL_ZTENHA, YL_ZTENQVA, YL_ZTENT)
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
  ...
  DO JBLK = 1, YDCPG_OPTS%KGPBLKS
    ...
    &, YDCPG_OPTS%KLON, ZPCLS(:, JBLK), Z_YDMF_PHYS_OUT_TCLS(:, JBLK), Z_YDMF_PHYS_BASE_STATE_Q&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
  ...
  DO JBLK = 1, YDCPG_OPTS%KGPBLKS
      ...
      &, YDCPG_OPTS%KLON, ZPCLS(:, JBLK), Z_YDMF_PHYS_OUT_TCLS(:, JBLK), Z_YDMF_PHYS_BASE_STATE_Q (:, YDCPG_OPTS&
      &%KFLEVG, JBLK), Z_YDMF_PHYS_BASE_STATE_L (:, YDCPG_OPTS%KFLEVG, JBLK), Z_YDMF_PHYS_BASE_STATE_I &
...
&, YDVARS, YDMODEL, YDDDH, YL_ZDIFEXT, YL_ZDSA_CPS, YL_ZMSC_FRMQ, YL_ZPFL_FEFB1&
