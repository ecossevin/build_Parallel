...
& YDCPG_GPAR, YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDCPG_SL2, YDVARS, YDMODEL, YDDDH)
...
#include "apl_arpege_dprecips_parallel.intfb.h"
  ...
  CLASS(FIELD_3RB), POINTER :: YL_ZGP2DSPP
  REAL(KIND=JPRB), POINTER :: ZGP2DSPP(:, :, :)
  ...
  CALL FIELD_NEW(YL_ZXUROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZXURO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZXTROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZXTRO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZXQRO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZTRAJGWD, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSEDIQL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSEDIQI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSAV_UNEBH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_UDOM, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_UDGRO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_UDAL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZSAV_ENTCH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_DDOM, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZSAV_DDAL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZRDG_LCVQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZRDG_CVGQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZQO3, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZQICE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZPRODTH_CVPP, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRC_DPRECIPS2, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%NDTPREC2, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPRC_DPRECIPS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%NDTPREC, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPOID, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPFL_FTKEI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPFL_FTKE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPFL_FEFB3, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPFL_FEFB2, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZPFL_FEFB1, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZNBVNO, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_TW, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_QW, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_LSCPE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_LH, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMSC_FRMQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMRIPP, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZMF_UP, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZLVT, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZKUROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZKTROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZKQROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZKQLROV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZGP2DSPP, UBOUNDS=(/ YDCPG_OPTS%KLON, YDMODEL%YRML_GCONF%YRSPP_CONFIG%SM%NRFTOTAL, YDCPG_OPTS%KGPBLKS /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZGEOSLC, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFPLSN, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFPLSL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFPCOR, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLX_LOTT_GWV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLX_LOTT_GWU, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZFLU_QSAT, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLU_NEIJ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZFLU_FEVI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KTSSG + 1, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZEDMFV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZEDMFU, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZEDMFS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZEDMFQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  & UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDMODEL%YRML_GCONF%YGFL%NGFL_EXT, YDCPG_OPTS%KGPBLKS /),  &
  & LBOUNDS=(/ 1, 0, 1, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDIFCVPPV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDIFCVPPU, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDIFCVPPS, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZDIFCVPPQ, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZCTRSO, UBOUNDS=(/ YDCPG_OPTS%KLON, 1, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCRTI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCP, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCONDCVPPL, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCONDCVPPI, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCOEFN, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCOEFA, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZCEMTR, UBOUNDS=(/ YDCPG_OPTS%KLON, 1, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZCE, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  ...
  CALL FIELD_NEW(YL_ZBAY_QSCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZBAY_QRCONV, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), PERSISTENT=.true.)
  CALL FIELD_NEW(YL_ZALPHA1, UBOUNDS=(/ YDCPG_OPTS%KLON, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KGPBLKS /), LBOUNDS=(/ 1, 0, 1 /),  &
  & PERSISTENT=.true.)
...
!$ACC PARALLEL LOOP GANG
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZFLU_QSATS, ZRDG_CVGQ, ZRDG_LCVQ) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON)
...
!$ACC PARALLEL LOOP GANG
    ...
    !$ACC&         ZDSA_LHS, ZDSA_RS, ZFLU_CD, ZFLU_CDN, ZFLU_CH, ZFLU_EMIS, ZFLU_FEVI, &
    !$ACC&         ZFLU_NEIJ, ZFLU_QSAT, ZFLU_QSATS, ZFLU_VEG, ZMSC_FRMQ, ZMSC_LH, &
    !$ACC&         ZMSC_LSCPE, ZMSC_QW, ZMSC_TW, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, &
    !$ACC&         ZPFL_FTKE, ZPFL_FTKEI, Z_YDMF_PHYS_SURF_GSD_VF_PVEG) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON)
...
!$ACC LOOP VECTOR
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%LGCHECKMV) THEN
    ...
    IF (LPARALLELMETHOD('OpenMP', 'APL_ARPEGE_PARALLEL:CHECKMV')) THEN
      ...
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYD)
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
...
!$OMP PARALLEL DO PRIVATE( JBLK ) FIRSTPRIVATE( YLCPG_BNDS )
  ...
  IF (LPARALLELMETHOD('OPENMP', 'APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
    ...
    Z_YDMF_PHYS_BASE_STATE_T => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%F_T)
    Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%F_CP)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
    ...
    Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%F_CP)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, LLHMT ) FIRSTPRIVATE( YLCPG_BNDS )
      ...
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        ...
        IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
          ...
          & Z_YDMF_PHYS_SURF_GSD_VF_PZ0F(:, JBLK), Z_YDMF_PHYS_SURF_GSD_VV_PZ0H(:, JBLK),  &
          ...
          & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A(:, 1, JBLK), Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R(:, 1, JBLK),  &
          & Z_YDMF_PHYS_SURF_GSD_VV_PSAB(:, JBLK), Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F(:, 1, JBLK),  &
      ...
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        ...
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          ...
          IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
            ...
            & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC(:, JBLK), LLHMT, ZDSA_C1(:, JBLK), ZDSA_C2(:, JBLK), ZC3(:, JBLK), ZCG(:, JBLK),  &
            & ZCN(:, JBLK), Z_YDMF_PHYS_OUT_CT(:, JBLK), ZNEIJG(:, JBLK), ZNEIJV(:, JBLK), ZWFC(:, JBLK), ZWPMX(:, JBLK),  &
            & ZWSEQ(:, JBLK), ZWSMX(:, JBLK), ZWWILT(:, JBLK), YDSTACK=YLSTACK)
          ELSE
...
!$ACC LOOP VECTOR
  ...
  IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    IF (LPARALLELMETHOD('OPENMP', 'APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
      ...
      Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
      Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHIF)
      Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%F_R)
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYD)
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
      Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON ) FIRSTPRIVATE( YLCPG_BNDS )
      ...
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        ...
        DO JLON=YLCPG_BNDS%KIDIA,YLCPG_BNDS%KFDIA
          ...
          & *Z_YDMF_PHYS_BASE_STATE_T(JLON, YDCPG_OPTS%KFLEVG, JBLK) + YDMODEL%YRCST%RKAPPA*ZDPHI(JLON, JBLK) + ZPRS(JLON, JBLK) &
          & *Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON, JBLK))
        END DO
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
      ...
      Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHIF)
      Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_DYN%RCP%F_R)
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYD)
      Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
      Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
...
!$OMP PARALLEL DO PRIVATE( JBLK ) FIRSTPRIVATE( YLCPG_BNDS )
      ...
      DO JBLK=1,YDCPG_OPTS%KGPBLKS
        ...
        & Z_YDMF_PHYS_SURF_GSD_VF_PLSM(:, JBLK), ZNEIJG(:, JBLK), ZNEIJV(:, JBLK), Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F(:, 1, JBLK),  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLEV, JLON ) FIRSTPRIVATE( YLCPG_BNDS )
    ...
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
      ...
      DO JLEV=YDCPG_OPTS%KTDIA,YDCPG_OPTS%KFLEVG
        ...
        DO JLON=YLCPG_BNDS%KIDIA,YLCPG_BNDS%KFDIA
          ZTHETAV(JLON, JLEV, JBLK) = Z_YDMF_PHYS_BASE_STATE_T(JLON, JLEV, JBLK)*(1.0_JPRB + YDMODEL%YRCST%RETV*ZQV(JLON, JLEV,  &
          & JBLK))*(YDMODEL%YRCST%RATM / Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF(JLON, JLEV, JBLK))**YDMODEL%YRCST%RKAPPA
        END DO
      ...
      DO JLON=YLCPG_BNDS%KIDIA,YLCPG_BNDS%KFDIA
        ZTHETAVS(JLON, JBLK) = Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON, JBLK)*(1.0_JPRB + YDMODEL%YRCST%RETV*Z_YDCPG_MISC_QS(JLON,  &
        & JBLK))*(YDMODEL%YRCST%RATM / Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD(JLON, YDCPG_OPTS%KFLEVG, JBLK)) &
...
!$ACC PARALLEL LOOP GANG
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZDIFCVPPQ, ZDIFCVPPS, ZDIFCVPPU, ZDIFCVPPV, &
    !$ACC&         Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_STRTU, &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON ) FIRSTPRIVATE( YLCPG_BNDS )
    ...
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
      ...
      DO JLON=YLCPG_BNDS%KIDIA,YLCPG_BNDS%KFDIA
        ...
        IF (.not.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
          Z_YDMF_PHYS_OUT_FRTHDS(JLON, JBLK) = Z_YDMF_PHYS_OUT_FRTH(JLON, YDCPG_OPTS%KFLEVG, 1, JBLK) / ZFLU_EMIS(JLON, JBLK) +  &
          & YDMODEL%YRCST%RSIGMA*Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T(JLON, JBLK)**4
        END IF
...
!$ACC LOOP VECTOR
  ...
  IF (LPARALLELMETHOD('OPENMP', 'APL_ARPEGE_PARALLEL:ACDRAG')) THEN
    ...
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYD)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_DELP)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
    Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T => GET_HOST_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACDRAG')) THEN
    ...
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYD)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_DELP)
    Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
    Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T => GET_DEVICE_DATA_RDONLY(YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    DO JBLK=1,YDCPG_OPTS%KGPBLKS
      ...
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        ...
        & ZPCLS(:, JBLK), Z_YDMF_PHYS_OUT_TCLS(:, JBLK), Z_YDMF_PHYS_BASE_STATE_Q(:, YDCPG_OPTS%KFLEVG, JBLK),  &
        & Z_YDMF_PHYS_BASE_STATE_L(:, YDCPG_OPTS%KFLEVG, JBLK), Z_YDMF_PHYS_BASE_STATE_I(:, YDCPG_OPTS%KFLEVG, JBLK),  &
        & Z_YDMF_PHYS_OUT_TPWCLS(:, JBLK), YDSTACK=YLSTACK)
      END DO
...
!$ACC LOOP VECTOR
  ...
  IF (YDCPG_OPTS%LCORWAT) THEN
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21', 0, ZHOOK_HANDLE_PARALLEL)
    
    IF (LPARALLELMETHOD('OpenMP', 'APL_ARPEGE_PARALLEL:21')) THEN
      
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:GET_DATA', 0, ZHOOK_HANDLE_FIELD_API)
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
...
!$OMP PARALLEL DO PRIVATE( JBLK ) FIRSTPRIVATE( YLCPG_BNDS )
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:COMPUTE', 1, ZHOOK_HANDLE_COMPUTE)
      
      IF (LSYNCHOST('APL_ARPEGE_PARALLEL:21')) THEN
        IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:SYNCHOST', 0, ZHOOK_HANDLE_FIELD_API)
        ...
        Z_YDMF_PHYS_SURF_GSD_VH_PPSL => GET_HOST_DATA_RDWR(YDMF_PHYS_SURF%GSD_VH%F_PSL)
        Z_YDMF_PHYS_SURF_GSD_VH_PPSN => GET_HOST_DATA_RDWR(YDMF_PHYS_SURF%GSD_VH%F_PSN)
        IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:SYNCHOST', 1, ZHOOK_HANDLE_FIELD_API)
        
        
      END IF
      
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:NULLIFY', 0, ZHOOK_HANDLE_FIELD_API)
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21:NULLIFY', 1, ZHOOK_HANDLE_FIELD_API)
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:21', 1, ZHOOK_HANDLE_PARALLEL)
  END IF
...
!$ACC LOOP VECTOR
  ...
  IF (ASSOCIATED(YL_ZGP2DSPP)) CALL FIELD_DELETE(YL_ZGP2DSPP)
...
! 60c94f6648f0968cd358c1945c1de86cdba214f3
