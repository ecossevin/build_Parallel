...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:CPPHINP')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:CPPHINP:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:CPPHINP:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZRDG_SOLO, ZRDG_MU0LU, ZRDG_CVGQ, ZRDG_CVGT,  &
!$ACC & ZRDG_MU0N, ZRDG_MU0M, Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_U_T0, Z_YDVARS_V_T0, Z_YDVARS_CVGQ_DM, Z_YDVARS_CVGQ_T0,  &
!$ACC & Z_YDVARS_Q_T0, Z_YDVARS_Q_DM, Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDVARS_Q_DL, Z_YDVARS_T_DL, Z_YDVARS_GEOMETRY_GEMU_T0,  &
!$ACC & Z_YDVARS_CVGQ_DL, Z_YDCPG_DYN0_CTY_EVEL, Z_YDVARS_T_DM ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ZRDG_LCVQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZRDG_LCVQ, ZFLU_QSATS, ZRDG_CVGQ, ZQCO2 ) PRIVATE( JBLK )  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:APLPAR_INIT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:APLPAR_INIT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_QSAT, ZMSC_FRMQ, ZFLU_CHN, ZPFL_FEFB3, ZDSA_RS,  &
!$ACC & ZPFL_FTKEI, ZMSC_LSCPE, ZMSC_TW, ZFLU_CDN, ZFLU_QSATS, ZDSA_C1, ZFCHQ, ZPFL_FEFB1, ZMSC_LH, ZMSC_QW, ZDSA_LHS,  &
!$ACC & ZDSA_C2, ZFLU_EMIS, ZFLU_NEIJ, ZFLU_FEVI, ZDSA_CPS, IMOC_CLPH, ZFLU_VEG, ZPFL_FEFB2, Z_YDMF_PHYS_SURF_GSD_VF_PVEG )  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACTQSAT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_QSAT, ZQV, ZGEOSLC, ZMSC_LSCPE, ZMSC_TW, ZMSC_LH,  &
!$ACC & ZMSC_QW, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_RH, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK, LLHMT )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACSOL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACSOL:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACSOL:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZWPMX, ZWFC, ZCN, ZDSA_C1, ZDSA_C2, ZWWILT, ZNEIJG, ZC3, ZCG,  &
!$ACC & ZNEIJV, ZWSEQ, ZWSMX, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_SURF_GSD_VV_PLAI, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_OUT_CT,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, Z_YDMF_PHYS_SURF_GSD_VV_PARG, Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VV_PSAB ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMTLS:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMTLS:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDPHIT, ZGWDCS, ZFLU_CDN, ZRTI, ZNBVNO, ZDSA_LHS, ZPCLS,  &
!$ACC & ZPRS, ZMRIPP, ZDSA_CPS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_T, Z_YDCPG_MISC_QS,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACHMT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACHMT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZHU, ZNBVNO, ZRTI, ZXHROV, ZPFL_FPLCH, ZDPHIV, ZGWDCS,  &
!$ACC & ZCDROV, ZCHROV, ZPCLS, ZNEIJG, ZFLU_VEG, ZFLU_QSATS, ZDQSTS, ZFLU_NEIJ, ZFLU_CH, ZDPHIT, ZQV, ZWFC, ZDSA_RS,  &
!$ACC & ZPFL_FPLSH, ZHQ, ZFLU_CDN, ZNEIJV, ZMRIPP, ZXDROV, ZDSA_CPS, ZSTAB, Z_YDMF_PHYS_SURF_GSD_VV_PHV,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_OUT_UGST,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_OUT_TCLS,  &
!$ACC & Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_OUT_RHCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  &
!$ACC & Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_OUT_NUCLS, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_OUT_QCLS,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PLSM ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
          YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACCLPH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACCLPH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACCLPH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZTHETAVS, ZUGST, ZQV, ZBLH, ZVGST, ZCP, IMOC_CLPH,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
!$ACC & Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_VEIN,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_U  &
!$ACC & ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:DIFTQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:DIFTQ:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:DIFTQ:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZDIFCVPPS, ZDIFCVPPV, ZDIFCVPPU, ZEDMFU, ZDIFCVPPQ, ZEDMFV,  &
!$ACC & ZEDMFS, ZEDMFQ, Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV )  &
!$ACC & PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:FRSOPT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:FRSOPT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:FRSOPT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_EMIS, ZRDG_MU0, Z_YDMF_PHYS_OUT_FRTHDS,  &
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACDRAG')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRAG:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRAG:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZQV, ZGWDCS, ZCHROV, ZTRAJGWD, ZNBVNO, ZDQSTS, ZMSC_QW,  &
!$ACC & ZQLIS, ZFLU_EMIS, ZFLU_NEIJ, ZNEBS, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_BASE_STATE_T,  &
!$ACC & Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  &
!$ACC & Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN,  &
!$ACC & Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_DRNSHF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  &
!$ACC & Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_BASE_STATE_U ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZECTCLS, ZTKE1, ZKUROV2, ZPFL_FTKE, ZUSLE, ZKCLS, ZPRODTH,  &
!$ACC & Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP,  &
!$ACC & Z_YDMF_PHYS_OUT_STRCV, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_DIFCQ, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:QNGCOR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:QNGCOR:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:QNGCOR:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZFPLSL, ZQV, ZFLX_LOTT_GWV, ZFPCOR, ZPFL_FPLCH, ZSEDIQL, ZQL,  &
!$ACC & ZQI, ZPFL_FPLSH, ZSEDIQI, ZFLX_LOTT_GWU, ZFPLSN, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPFPSL,  &
!$ACC & Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_OUT_DIFCQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_FPEVPCN, Z_YDMF_PHYS_OUT_FCQNG, Z_YDMF_PHYS_OUT_DIFTQN,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FCSQL,  &
!$ACC & Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_DIFCQL, Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FPLSG,  &
!$ACC & Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FPLSN ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACDRME')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRME:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACDRME:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, YDGEOMETRY, ZMSC_FRMQ, ZQV, Z_YDCPG_MISC_QICE,  &
!$ACC & Z_YDVARS_LRAD_T1, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDVARS_IRAD_T1,  &
!$ACC & Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  &
!$ACC & Z_YDMF_PHYS_OUT_STRMV, Z_YDMF_PHYS_BASE_STATE_U, Z_YDVARS_A_T1, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QLI ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
    ...
    ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACEVADCAPE:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACEVADCAPE:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZTKE1, ZBLH, IMOC_CLPH, ZDCAPE, Z_YDMF_PHYS_OUT_UCLS,  &
!$ACC & Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_OUT_FPLSN,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_FPLSL,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_OUT_FPLCL, Z_YDVARS_GEOMETRY_OROG_T0,  &
!$ACC & Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_OUT_VGST,  &
!$ACC & Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF ) PRIVATE( JBLK )  &
!$ACC & VECTOR_LENGTH( YDCPG_OPTS%KLON )
      DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
        DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:ACVISIH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACVISIH:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:ACVISIH:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZQGM, ZQR, ZQS, Z_YDMF_PHYS_OUT_VISICLD,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_OUT_VISIHYD,  &
!$ACC & Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_MXCLWC,  &
!$ACC & Z_YDCPG_MISC_QICE, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PPWETPOINT:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PPWETPOINT:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZPCLS, Z_YDMF_PHYS_OUT_TCLS, Z_YDMF_PHYS_BASE_STATE_L,  &
!$ACC & Z_YDMF_PHYS_OUT_TPWCLS, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_I ) PRIVATE( JBLK ) VECTOR_LENGTH(  &
!$ACC & YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
...
!$OMP PARALLEL DO PRIVATE( JBLK, JLON, YLCPG_BNDS, YLSTACK )
  ...
  ELSE IF (LPARALLELMETHOD('OPENACCSINGLECOLUMN', 'APL_ARPEGE_PARALLEL:PRECIPS')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PRECIPS:GET_DATA', 1, ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK('APL_ARPEGE_PARALLEL:PRECIPS:COMPUTE', 0, ZHOOK_HANDLE_COMPUTE)
!$ACC PARALLEL LOOP GANG PRESENT( YDCPG_OPTS, YDMODEL, YSTACK, ZPRC_DPRECIPS2, Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2,  &
!$ACC & Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP ) PRIVATE( JBLK ) VECTOR_LENGTH( YDCPG_OPTS%KLON )
    DO JBLK=YDCPG_OPTS%JBLKMIN,YDCPG_OPTS%JBLKMAX
!$ACC LOOP VECTOR PRIVATE( JLON, YLCPG_BNDS, YLSTACK )
      DO JLON=1,MIN(YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1)*YDCPG_OPTS%KLON)
        YLCPG_BNDS%KIDIA = JLON
