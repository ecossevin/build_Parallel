...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    &,:, JBLK), ZRDG_MU0(:, JBLK), ZRDG_SOLO(:, JBLK), ZRDG_MU0LU(:, JBLK), ZRDG_MU0M(:, JBLK),&
    & ZRDG_MU0N(:, JBLK), ZRDG_CVGQ(:,:, JBLK), ZRDG_CVGT(:,:, JBLK))  
  ENDDO
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
      ...
      &), Z_YDVARS_T_DL(:,:, JBLK), Z_YDVARS_T_DM(:,:, JBLK), Z_YDVARS_Q_T0(:,:, JBLK), Z_YDVARS_Q_DL&
      &(:,:, JBLK), Z_YDVARS_Q_DM(:,:, JBLK), Z_YDVARS_CVGQ_DL(:,:, JBLK), Z_YDVARS_CVGQ_DM(:,:, JBLK&
      &), Z_YDCPG_PHY0_XYB_RDELP(:,:, JBLK), Z_YDCPG_DYN0_CTY_EVEL(:,:, JBLK), Z_YDVARS_CVGQ_T0(:,:,&
...
! f2ae04c6a09fcc7bb0550cfd98913aa46b857eda
